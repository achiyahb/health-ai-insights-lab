          ...
          <div className="flex items-start space-x-4 space-x-reverse">
            ...
            <div className="flex-1">
              ...
              <div className="text-gray-700 leading-relaxed space-y-3">
                <p>
                  במהלך היום עברנו יחד הרצאת מבוא שהציגה את מהפכת ה-AI, ולמה כדאי 
                  ללמוד ולהשתמש בו. למדנו גם מושגים מעולמות הAI וכיצד הוא עובד מאחורי הקלעים.
                </p>
                <p>
                  צפינו בהדגמות של מגוון אפשרויות בהן יישומי AI יכולים לתמוך בעבודתכם 
                  המקצועית, הן בניהול והן בתהליכי טיפול.
                </p>
                <p>
                  למדנו גם על מצב הרגולציה בישראל ובעולם, וכן על סכנות הטמונות בשימוש 
                  בו וכיצד ניתן להיזהר מהן
                </p>
                <p>
                  לסיום, קיימנו סדנה מעשית, שבה תרגלתם פרומטינג ושימוש ביישומי AI 
                  תוך חיבור ישיר לעשייה הטיפולית היומיומית שלכם.
                </p>
