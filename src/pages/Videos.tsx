...
const Videos = () => {
  ...
  const videos = [
    ...
    },
    {
      ...
      description: "איך להשתמש ב-Explore GPTs כדי לקבל בוט יותר ממוקד לעולם התוכן שלנו",
    ...
    },
    {
      ...
      description: "אחרי שבנינו אתר עם קלוד, איך מעלים אותו לאינטרנט בקלות ובחינם",
      icon: "message-square" as const
    },
    {
      embedId: "-Csg9lIAGNA",
    ...
    {
      embedId: "xp-mk9ojQds",
      title: "ציור תמונות עם Dall-e",
      description: "איך משתמשים בDall-e כדי ליצור איזה תמונה שנרצה. שימו לב: יש כבר שיטות יותר טובות ליצירת תמונות - סרטון על כך בקרוב!",
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-white py-10 md:py-16 border-b">
        <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
          <h1 className="text-3xl font-bold mb-3 text-center">מדריכי שימוש במערכות AI 🤖</h1>
          <p className="text-xl text-gray-600 text-center max-w-3xl mx-auto">
            להלן סרטוני הדרכה קצרים שיעזרו לכם להתחיל להשתמש בכלים חדשניים בעבודה הטיפולית שלכם. כל הסרטונים באורך קצר ועם דוגמאות מהשדה.
          </p>
        </div>
      </section>
